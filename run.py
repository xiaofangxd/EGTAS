...
def parse_args():
    ...
    parser.add_argument('--data_name',type=str,default='COX2_MD')
    ...
    parser.add_argument('--use_all_node', type=boolean_string, default=False) # node classcaition in multi-graphs
    ...
    parser.add_argument('--use_gnn_layers', type=boolean_string, default=True)
    ...
    parser.add_argument('--gnn_type',type=str,default='GCN') #GCN,SAGE,GAT,RGCN ... any types of GNN supported by Geometric
    parser.add_argument('--gnn_dropout',type=float,default=0.5)

    # architecture topology
    parser.add_argument('--topology', type=str, default='vanilla')#'vanilla'/'Res'/'JK'/'GCNII' gnn insert position
    ...
    parser.add_argument('--output_dir',type=str, default='./output')#G#v2'./output'
    ...
    parser.add_argument('--max_steps',type=int,default=10000)# not use, we use the num_train_epochs
...
if __name__=='__main__':
    ...
    if args.data_name in ('Cora','Flickr','ogbn-products','ogbn-arxiv'):
    ...
    elif args.data_name in ('ZINC','UPFD','ogbg-molpcba','ZINC-full',"ogbg-molhiv","COX2_MD", "BZR_MD", "PTC_FM", "DHFR_MD", "PROTEINS", "DBLP_v1","ogbg-molbace","ogbg-molbbbp"):
    ...
    output_dir = args.output_dir + '/' +'_'.join(log_file_param_list_p)
    # output_dir ='./surr_outputs/'+'_'.join(log_file_param_list_p)
    ...
    trainer = MyTrainer(
        ...
        callbacks=[MyCallback,EarlyStoppingCallback(early_stopping_patience=50)]
    )
    if args.use_gnn_layers:
